...
const AllAdminCoupon = () => {
    ...
    const fetchCoupons = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('https://testapi.dessobuild.com/api/v1/all_admin_coupon');
    ...
    const deleteCoupon = async (id) => {
        setLoading(true);
        try {
            await axios.delete(`https://testapi.dessobuild.com/api/v1/delete_admin_coupon/${id}`);
            fetchCoupons();
