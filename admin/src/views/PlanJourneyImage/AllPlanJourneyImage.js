...
function AllPlanJourneyImage() {
    ...
    const handleUpdateActive = async (id, currentStatus) => {
        ...
        try {
            ...
            await axios.put(`https://testapi.dessobuild.com/api/v1/update-plan-banner-status/${id}`, {
    ...
    const handleDeleteBanner = async (id) => {
        setLoading(true);
        try {
            await axios.delete(`https://testapi.dessobuild.com/api/v1/delete-plan-journey-image/${id}`);
